/** @file
 *  @brief MAVLink comm protocol generated from tx1_debug.xml
 *  @see http://mavlink.org
 */
#pragma once
#ifndef MAVLINK_TX1_DEBUG_H
#define MAVLINK_TX1_DEBUG_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_TX1_DEBUG.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_tx1_debug_request_fp_tracked.h"
#include "./mavlink_msg_tx1_debug_status_fp_tracked.h"
