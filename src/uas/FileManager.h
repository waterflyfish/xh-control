...
public:
    ...
    /* changed by gc 20160420
    static const int ackTimerTimeoutMsecs = 10000;
    */
    static const int ackTimerTimeoutMsecs = 2000;
    /* change end 20160420 */
    ...
    /// overload Upload the specified file to the specified location
    ...
    void uploadPath(const QString& toPath, const QFileInfo& uploadFile, int selectedFirmware);
...
signals:
    ...
    void nextFirmwareUpgrade(bool sucess = true);
...
private:
    ...
    enum Opcode
	{
        ...
        kCmdReboot = 100,       ///< Restart the device when the firmware is completed.
