...
public:
    ...
    bool                isPosCtlMode                    (Vehicle* vehicle) final;
    ...
    void                guidedModeParachute             (Vehicle* vehicle) final;
    void                guidedModeVTOLMcandFw           (Vehicle* vehicle) final;
    void                guidedModeMission               (Vehicle* vehicle) final;
    void                guidedModePosition              (Vehicle* vehicle) final;
...
//    void                guidedModeChangeAltitude        (Vehicle* vehicle, double altitudeRel) final;
    ...
    bool                isFollowMeMode                  (const Vehicle* vehicle) const;
    ...
    //========================================================
    QString             missionCommandOverridesAdd         (MAV_TYPE vehicleType) const final;
    ...
    //=================================================================
    QString             internalParameterMetaDataFileAdd(void) final { return QString(":/FirmwarePlugin/PX4/PX4ParameterFactMetaDataAdd.xml"); }
