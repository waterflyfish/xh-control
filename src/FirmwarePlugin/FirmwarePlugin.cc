...
bool FirmwarePlugin::isPosCtlMode(Vehicle *vehicle)
{
    Q_UNUSED(vehicle);
    return false;
}
...
QString FirmwarePlugin::missionCommandOverrides(MAV_TYPE vehicleType) const
{
    ...
    case MAV_TYPE_GENERIC:
        if(m==false)return QStringLiteral(":/json/MavCmdInfoCommon.json");
        if(m==true)return QStringLiteral(":/json/MavCmdInfoCommonAdd.json");
        break;
    case MAV_TYPE_FIXED_WING:
        if(m==false)return QStringLiteral(":/json/MavCmdInfoFixedWing.json");
        if(m==true)return QStringLiteral(":/json/MavCmdInfoFixedWingAdd.json");
        break;
    case MAV_TYPE_QUADROTOR:
        if(m==false)return QStringLiteral(":/json/MavCmdInfoMultiRotor.json");
        if(m==true)return QStringLiteral(":/json/MavCmdInfoMultiRotorAdd.json");
        break;
    case MAV_TYPE_VTOL_QUADROTOR:
        if(m==false)return QStringLiteral(":/json/MavCmdInfoVTOL.json");
        if(m==true)return QStringLiteral(":/json/MavCmdInfoVTOLAdd.json");
        break;
    case MAV_TYPE_SUBMARINE:
        if(m==false)return QStringLiteral(":/json/MavCmdInfoSub.json");
        if(m==true)return QStringLiteral(":/json/MavCmdInfoSubAdd.json");
        break;
    case MAV_TYPE_GROUND_ROVER:
        if(m==false)return QStringLiteral(":/json/MavCmdInfoRover.json");
        if(m==true)return QStringLiteral(":/json/MavCmdInfoRoverAdd.json");
        break;
    default:
...
bool FirmwarePlugin::isFollowMeMode(const Vehicle* vehicle) const
{
    // Not supported by generic vehicle
    Q_UNUSED(vehicle);
    return false;
...
void FirmwarePlugin::guidedModeParachute(Vehicle *vehicle)
{
    Q_UNUSED(vehicle);
    qgcApp()->showMessage(guided_mode_not_supported_by_vehicle);
}

void FirmwarePlugin::guidedModeMission(Vehicle *vehicle)
{
    Q_UNUSED(vehicle);
    qgcApp()->showMessage(guided_mode_not_supported_by_vehicle);
}

void FirmwarePlugin::guidedModePosition(Vehicle *vehicle)
{
    Q_UNUSED(vehicle);
    qgcApp ()->showMessage (guided_mode_not_supported_by_vehicle);
}

void FirmwarePlugin::guidedModeVTOLMcandFw(Vehicle *vehicle)
{
    Q_UNUSED(vehicle);
    qgcApp ()->showMessage (guided_mode_not_supported_by_vehicle);
}
...
//====================================================================
QString FirmwarePlugin::missionCommandOverridesAdd(MAV_TYPE vehicleType) const
{
    switch (vehicleType) {
    case MAV_TYPE_GENERIC:
        return QStringLiteral(":/json/MavCmdInfoCommonAdd.json");
        break;
    case MAV_TYPE_FIXED_WING:
        return QStringLiteral(":/json/MavCmdInfoFixedWingAdd.json");
        break;
    case MAV_TYPE_QUADROTOR:
        return QStringLiteral(":/json/MavCmdInfoMultiRotorAdd.json");
        break;
    case MAV_TYPE_VTOL_QUADROTOR:
        return QStringLiteral(":/json/MavCmdInfoVTOLAdd.json");
        break;
    case MAV_TYPE_SUBMARINE:
        return QStringLiteral(":/json/MavCmdInfoSubAdd.json");
        break;
    case MAV_TYPE_GROUND_ROVER:
        return QStringLiteral(":/json/MavCmdInfoRoverAdd.json");
        break;
    default:
        qWarning() << "FirmwarePlugin::missionCommandOverrides called with bad MAV_TYPE:" << vehicleType;
        return QString();
