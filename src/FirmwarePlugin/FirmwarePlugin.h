...
public:
    ...
    typedef enum {
        ...
        ParatureModeCapability =            1 << 5, ///< Vehicle supports parature mode
        McandFwModeCapability =             1 << 6, ///< VTOL FW and MC mode support
    ...
    virtual bool   isPosCtlMode   (Vehicle* vehicle);
    ...
    /// Returns whether the vehicle is in follow me mode or not.
    virtual bool isFollowMeMode(const Vehicle* vehicle) const;
    ...
    virtual void guidedModeParachute(Vehicle* vehile);

    ///Command vehicle to Switch to mission mode
    virtual void guidedModeMission(Vehicle* vehicle);

    ///Command vehicle to switch to position ctl mode
    virtual void guidedModePosition(Vehicle* vehilce);

    virtual void guidedModeVTOLMcandFw(Vehicle* vehicle);
...
//    virtual void guidedModeChangeAltitude(Vehicle* vehicle, double altitudeRel);
    ...
    //=====================================================================
    virtual QString internalParameterMetaDataFileAdd(void) { return QString(); }
    ...
    //====================================================================
    virtual QString missionCommandOverridesAdd(MAV_TYPE vehicleType) const;
