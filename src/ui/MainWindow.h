...
public:
    ...
    ///Virtual Stick Controlled by KeyEvents
...
private slots:
    ...
    //===================================
     void _showDockWidgetActionAdd(bool show);
#endif
...
private:
    ...
    //============================================
    bool _createInnerDockWidgetAdd(const QString& widgetName);
    ...
    //==========================================
    void _showDockWidgetAdd(const QString &name, bool show);
#endif

    bool                    _lowPowerMode;           ///< If enabled, QGC reduces the update rates of all widgets
    bool                    _showStatusBar;
    QString                 _applicationname;
    QString                 _appChineseName;
    QString                 _appEnglishName;
