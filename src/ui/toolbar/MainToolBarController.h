...
public:
    ...
    Q_PROPERTY(bool         firmwareNew         READ firmwareNew                WRITE setFirmwareNew    NOTIFY firmwareNewChanged)
    ...
    bool         firmwareNew            () { return _firmwareNew;}
    QString      detailsText            () { return _detailsText;}

    void loadFirmwareVersionXml();
    bool XmlReaderStart();
    bool ReaderPilotStackType();
    bool ReaderFirmwareType();
    bool ReaderVersion();
    QString vehicleFirmwareVersion(Vehicle *vehicle);
signals:
    ...
    void detailsTextChanged             (QString detailsText);
    void firmwareNewChanged             (bool value);
    void newfirmwarwVersion(const QString &version, const QString &detailstext);
...
private slots:
    ...
    void setFirmwareNew                 (bool value);
    void setDetailsText                 (QString detailsText);
    void firmwareVersionXmlDownloadFinished(QString remoteFile, QString localFile);
    void versionCompare                 (const QString &version, const QString &detailstext);
