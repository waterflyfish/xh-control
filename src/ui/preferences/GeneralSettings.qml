    ...
    QGCViewPanel {
        ...
        QGCFlickable {
            ...
            Column {
                ...
                Item {
                    width:              qgcView.width * 0.8
                    height:             languageLabel.height
                    anchors.margins:    ScreenTools.defaultFontPixelWidth
                    anchors.horizontalCenter: parent.horizontalCenter
                    QGCLabel {
                        id:             languageLabel
                        text:           qsTr("language (Requires Restart)")
                        font.family:    ScreenTools.demiboldFontFamily
                    }
                }
                Rectangle {
                    ...
                    Column {
                        ...
                        Row {
                            ...
                            QGCLabel {
                                width:              _labelWidth
                                anchors.baseline:   languageCombo.baseline
                                text:               qsTr("language:")
                            }
                            FactComboBox {
                                id:                 languageCombo
                                width:              _editFieldWidth
                                model: [qsTr("language choice"),qsTr("Chinese"), qsTr("English")]
                                onActivated: {
                                    if(index==1)QGroundControl.languageIndex=1
                                    if(index==2)QGroundControl.languageIndex=2
                                }
                            }
                        }
                    }
                ...
                QGCLabel {
                    anchors.horizontalCenter:   parent.horizontalCenter
                    text:                       qsTr("QGroundControl Version: ") + qsTr(QGroundControl.qgcVersion)
                }
            } // settingsColumn
        } // QGCFlickable
    } // QGCViewPanel
