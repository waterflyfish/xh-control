...
public:
   ...
   Q_INVOKABLE QVariantList getCommandsForCategory(Vehicle* vehicle, const QString& category);
    ...
    //============================================
    Q_PROPERTY(QVariantList*                  jsondat         READ jsondat                           NOTIFY jsondatChanged)
    virtual void setToolboxAdd(QGCToolbox* toolbox);
    virtual void setToolboxAddTwo(QGCToolbox* toolbox);
    QVariantList* jsondat       (void) { return &_jsondat; }  
	
signals:
    void jsondatChanged(void);           
...
private:
    ...
    void _buildAvailableCommandsAdd(Vehicle* vehicle);
...
private:
    ...
    //==================================================================
    QMap<MAV_AUTOPILOT, QMap<MAV_TYPE, MissionCommandList*>>                   _staticCommandTreeAdd;
