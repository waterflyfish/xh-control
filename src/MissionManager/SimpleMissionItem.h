...
public:
    ...
    Q_PROPERTY(double param2 READ param2                WRITE setParam2            NOTIFY param2Changed)
    Q_PROPERTY(double param3 READ param3                WRITE setParam3            NOTIFY param3Changed)
    Q_PROPERTY(double param4 READ param4                WRITE setParam4            NOTIFY param4Changed)
    ...
    double param2(void) const { return _missionItem.param2 (); }
    void setParam3(double param);
    double param3(void) const { return _missionItem.param3 (); }
    void setParam4(double param);
    double param4(void) const { return _missionItem.param4 (); }
    ...
    //===========================================================================
    bool            flage                    (void) const final {return _missionItem.flage();}
