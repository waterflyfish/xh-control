...
MissionItem::MissionItem(QObject* parent)
    ...
    , _autoContinueFact             (0, tr("AutoContinue"),                 FactMetaData::valueTypeUint32)
    , _commandFact                  (0, "",                                 FactMetaData::valueTypeUint32)
    , _frameFact                    (0, "",                                 FactMetaData::valueTypeUint32)
    , _param1Fact                   (0, tr("Param1:"),                      FactMetaData::valueTypeDouble)
    , _param2Fact                   (0, tr("Param2:"),                      FactMetaData::valueTypeDouble)
    , _param3Fact                   (0, tr("Param3:"),                      FactMetaData::valueTypeDouble)
    , _param4Fact                   (0, tr("Param4:"),                      FactMetaData::valueTypeDouble)
    , _param5Fact                   (0, tr("Latitude:"),                    FactMetaData::valueTypeDouble)
    , _param6Fact                   (0, tr("Longitude:"),                   FactMetaData::valueTypeDouble)
    , _param7Fact                   (0, tr("Altitude:"),                    FactMetaData::valueTypeDouble)
{
...
//==================================================
void MissionItem::setFlage(bool flage)
{
         // qDebug()<<flage<<"mmm";
        if(_flage!=flage){
            _flage=flage;
        }
        emit flageChanged(flage);
}
//============================================
