...
public:
    ...
    //drag wayline flag
   Q_PROPERTY(bool    flage                    READ flage                   WRITE setFlage       NOTIFY flageChanged)
    //
    ...
    //=================================================================
    virtual bool            flage                    (void) const = 0;
    //=================================================================
    ...
    //==================================================================
    virtual void setFlage             (bool flage) = 0;
