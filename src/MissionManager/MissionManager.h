...
public:
    ...
    const QList<MissionItem>& cameraFeedbackItems(void) { return _cameraFeedbackItems; }
    QList<MissionItem>& cameraFeedbackItems(bool changed) { Q_UNUSED(changed); return _cameraFeedbackItems; }
    //================================================================
    const QList<MissionItem*>& missionItemsflag(void) { return _missionItemsflag; }
    //===============================================================
...
signals:
    void missionItemsTempChanged (double latitude, double longtitude, double altitude);
    void newMissionItemsAvailable(void);
    void inProgressChanged(bool inProgress);
    void error(int errorCode, const QString& errorMsg);
    void currentItemChanged(int currentItem);
    void cameraFeedItemsChanged(int currentItem);
    void missionItemReceived(bool receive);

private slots:
    void _mavlinkMessageReceived(const mavlink_message_t& message);
    void _mavlinkMessageCameraFeed(const mavlink_message_t& message);
...
private:
    ...
    QList<MissionItem>  _cameraFeedbackItems;
    //=================================
    QList<MissionItem*> _missionItemsflag;
    //=================================
