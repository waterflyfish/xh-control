...
QGCView {
    ...
    function px4JoystickCheck() {
        if ( _activeVehicle &&_activeVehicle.isPosCtlMode && !_activeVehicle.supportsManualControl && (QGroundControl.virtualTabletJoystick || _activeVehicle.joystickEnabled)) {
    ...
    QGCViewPanel {
        ...
        Loader {
            ...
            property bool instrumentflag : flag
        }
        ...
        Loader {
            ...
            visible:                    QGroundControl.virtualTabletJoystick && _activeVehicle && _activeVehicle.isPosCtlMode
            anchors.bottom:             _flightVideoPipControl.top
            anchors.bottomMargin:       ScreenTools.defaultFontPixelHeight * 2
            anchors.horizontalCenter:   widgetsLoader.horizontalCenter
            source:                     "qrc:/qml/VirtualJoystick.qml"
            active:                     QGroundControl.virtualTabletJoystick &&_activeVehicle && _activeVehicle.isPosCtlMode
