...
stQGeoTileCacheQGCMapTypes kMapTypes[] = {
    ...
    {"GoogleChina Street Map",    UrlFactory::GoogleMapChina},
    {"GoogleChina Satellite Map", UrlFactory::GoogleSatelliteChina},
    {"GoogleChina Terrain Map",   UrlFactory::GoogleTerrainChina}
...
QGCMapEngine::concurrentDownloads(UrlFactory::MapType type)
{
    ...
    case UrlFactory::GoogleMapChina:
    case UrlFactory::GoogleSatelliteChina:
    case UrlFactory::GoogleTerrainChina:
