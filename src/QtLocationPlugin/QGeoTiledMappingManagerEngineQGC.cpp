...
:   QGeoTiledMappingManagerEngine()
{
    ...
    mapTypes << QGeoMapType(QGeoMapType::StreetMap,         "GoogleChina Street Map",   "GoogleChina street map",       false,  false, UrlFactory::GoogleMapChina);
    mapTypes << QGeoMapType(QGeoMapType::SatelliteMapDay,   "GoogleChina Satellite Map","GoogleChina satellite map",    false,  false, UrlFactory::GoogleSatelliteChina);
    mapTypes << QGeoMapType(QGeoMapType::TerrainMap,        "GoogleChina Terrain Map",  "GoogleChina terrain map",      false,  false, UrlFactory::GoogleTerrainChina);
