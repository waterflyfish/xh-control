...
signals:
     ...
     * @brief New data arrived
     *
     * The new data is contained in the mavlink_message_t data. The data is copied for each
     * receiving protocol. For high-speed links like image transmission this might
     * affect performance, for control links it is however desirable to directly
     * forward the link data.
     *
     * @param data the new mavlink_message_t
     */
    void mavMessageReceived(LinkInterface* link, mavlink_message_t data);
