...
public:
    ...
    Q_PROPERTY(Fact* voltages           READ voltages           CONSTANT)
    ...
    Fact* voltages                  (void) { return &_voltagesFact;}
    ...
    static const char* _voltagesFactName;
    ...
    static const int    _voltagesUnavailable;
...
public:
    ...
    Q_PROPERTY(QmlObjectListModel*  followMePoints          READ followMePoints                                         CONSTANT)
    ...
    Q_PROPERTY(bool                 isPosCtlMode            READ isPosCtlMode                                           NOTIFY isPosCtlModeChanged)
    ...
    Q_PROPERTY(bool followMeMode READ followMeMode CONSTANT)
    ...
    Q_PROPERTY(bool paratureModeSupported READ paratureModeSupported CONSTANT)

    Q_PROPERTY(bool vtolMcandFwModeSupported READ vtolMcandFwModeSupported CONSTANT)

    Q_PROPERTY(bool keyCtlAtitude READ keyCtlAtitude WRITE setKeyCtlAtitude NOTIFY keyCtlAtitudeChanged)
    ...
    ///Command vehicle to parachute at current location
    Q_INVOKABLE void guidedModeParachute(void);

    Q_INVOKABLE void guidedModeVTOLMcandFw(void);

    ///command vehicle to switch to missionMode
    Q_INVOKABLE void guidedModeMission(void);
    ...
    Q_INVOKABLE void guidedModeFollowMe(const QGeoCoordinate& gotoCoord);

    ///command to switch to Position Mode
    Q_INVOKABLE void guidedModePosition();
...
//    Q_INVOKABLE void guidedModeOrbit(const QGeoCoordinate& centerCoord = QGeoCoordinate(), double radius = NAN, double velocity = NAN, double altitude = NAN);
    ...
    /// Take a picture on the vehicle
    Q_INVOKABLE void setDigitalCameraControl(bool shot = true);

    /// Returns the MIS_DIST_1WP
    Q_INVOKABLE double getMisDistOneWp(void);//MIS_DIST_1WP
    ...
    Q_INVOKABLE void doCommandLon(int component, int command, float param1 , float param2 , float param3 , float param4 , float param5 , float param6 , float param7 );
    ...
    bool paratureModeSupported(void) const;
    bool vtolMcandFwModeSupported(void) const;
    // Property accessors
    ...
    Tx1Manager*         tx1Manager(void)        { return _tx1Manager; }
    ...
    bool isPosCtlMode(void);
    bool keyCtlAtitude(void);
    void setKeyCtlAtitude(bool isKeyPressed);
    ...
    QmlObjectListModel* followMePoints(void) { return &_mapFollowMeList; }
...
//    Fact* landSpeed         (void) { return &_landSpeedFact;}
//    Fact* takeoffSpeed      (void) { return &_takeoffSpeedFact;}
...
signals:
    ...
    void vehicletypeChanged(int type);
    ...
    void isPosCtlModeChanged(bool posctlMode);
    void keyCtlAtitudeChanged(bool isKeyPressed);
    ...
    ///Remote control Camera take picture
    void mavlinkCameraFeedBack(mavlink_message_t message);
...
private:
    ...
    QmlObjectListModel  _mapFollowMeList;
    QGeoCoordinate      _mapTrajectoryLastCoordinate;
    QGeoCoordinate      _mapTraFollowMeLastCoordinate;
    bool                _mapFollowMeHaveFirstCoordinate;
    ...
    ///< This is not an unique identifier,
    ///< but should allow to identify the commit using the main version number even for very large code bases.
    QString _flightCustomVersion;
