...
Rectangle {
    ...
    function  showAdcanceSetup()
    {
        panelLoader.setSource("AdvanceSetup.qml")
    }
    ...
    function showVehicleComponentPanel(vehicleComponent)
    {
        if (QGroundControl.multiVehicleManager.activeVehicle.armed && !vehicleComponent.allowSetupWhileArmed) {
            ...
            if (vehicleComponent.prerequisiteSetup != "") {
                _messagePanelText = vehicleComponent.prerequisiteSetup + qsTr(" setup must be completed prior to ") + vehicleComponent.name + qsTr(" setup.")
                panelLoader.setSourceComponent(messagePanelComponent)
            } else {
    ...
    Component {
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                text:                   qsTr("QGroundControl does not currently support setup of your vehicle type. ") +
    ...
    Component {
        ...
        Rectangle {
            ...
            QGCLabel {
                ...
                wrapMode:               Text.WordWrap
                font.pointSize:         ScreenTools.mediumFontPointSize
                text:                   qsTr("You are currently connected to a vehicle, but that vehicle did not return back the full parameter list. ") +
                                        qsTr("Because of this the full set of vehicle setup options are not available.")
    ...
    QGCFlickable {
        ...
        Column {
            ...
            SubMenuButton {
                ...
                setupIndicator: false
                exclusiveGroup: setupButtonGroup
                visible:        true//!ScreenTools.isMobile
                text:           qsTr("Firmware")
            ...
            SubMenuButton {
                setupIndicator: false
                exclusiveGroup: setupButtonGroup
                visible:        QGroundControl.multiVehicleManager.parameterReadyVehicleAvailable //&& ScreenTools.isDebug
