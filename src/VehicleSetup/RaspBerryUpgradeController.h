...
#ifndef RaspBerryUpgradeController_H
#define RaspBerryUpgradeController_H
...
class RaspBerryUpgradeController : public QObject
{
    Q_OBJECT

public:
    RaspBerryUpgradeController(QObject* parent = NULL);
    ~RaspBerryUpgradeController(){
        stopAckTimeout();
    }
    ...
    /// for the RaspBerryUpgradeController to timeout.
...
#endif  //RaspBerryUpgradeController_H
