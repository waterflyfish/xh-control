...
Rectangle {
    ...
    QGCButton {
        ...
        visible:                missionItem != null && missionItem.sequenceNumber != 0 && missionItem.isCurrentItem && !missionItem.rawEdit && missionItem.isSimpleItem
    ...
    function setupsource(){
        if(missionItem.isSimpleItem){
            return("qrc:/qml/SimpleItemEditor.qml")
        }else{
            if(vehicle && vehicle.vtol){
                return ("qrc:/qml/SurveyItemEditor1.qml")
            }else{
                return("qrc:/qml/SurveyItemEditor.qml")
            }
        }
    }
    Loader {
        ...
        source:             setupsource()//missionItem.isSimpleItem ? "qrc:/qml/SimpleItemEditor.qml" : "qrc:/qml/SurveyItemEditor.qml"
