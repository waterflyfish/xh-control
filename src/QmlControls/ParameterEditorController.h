...
public:
    ...
    Q_PROPERTY(float          pitch_p          READ    pitch_p  WRITE setPitch_p         NOTIFY pitch_pChanged)
	QList<QObject*> model(void);
    float pitch_p(){return _pitch_p;}
    void setPitch_p(float pitch_p);
static void _loadFormFilePicker();
signals:
